          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 col-sm-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Appointment Calender</h6>
            ...
            <div class="col-xl-4 col-lg-5 col-md-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Current Time</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    <div id="MyClockDisplay" class="clock" width="100%"></div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                   ...
                   -->
<<<<<<< HEAD:patient_dashboard.html

                   <div align="center" style="background: rgb(243, 243, 243); padding: 50px;color:white;">
=======
    <!--                <div align="center" style="background: #000; padding: 50px;color:white;">
>>>>>>> 3a7434fa98692d3bc8f8948ae3a5fcee7cfda3e9:patient_dashboard.php
                    <i class="fa fa-star fa-2x" data-index="0"></i>
                    <i class="fa fa-star fa-2x" data-index="1"></i>
                    <i class="fa fa-star fa-2x" data-index="2"></i>
                    <i class="fa fa-star fa-2x" data-index="3"></i>
