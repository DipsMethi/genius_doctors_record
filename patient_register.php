<?php include ("PHP/Backend/PatientRegisterPreprocessor.php"); ?> <!-- Import backend functionallity for register page -->
...
<body id="page-top">
  ...
  <div class="custom-control custom-checkbox mb-3">
      ...
      <label class="custom-control-label" for="tc"><a class="small" href="patient_terms&conditions.html"><b>Terms and Conditions</b></a></label>
  </div>
